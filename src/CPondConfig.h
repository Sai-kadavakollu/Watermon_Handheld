...
#define TOTAL_PONDS 40
#define FILENAME_IDSCONFIG "/idsConfig.txt"
#define PONDS_STATUS_CONFIG "/PondSActiveFile.txt"

/*POND_MAP_FRAME_STORED_STATUS*/
#define PONDMAP_VALUE_NOT_ACTIVE 0 //harvested - Grey
#define PONDMAP_VALUE_YET_TO_BE_TAKEN 1 //Active - White
#define PONDMAP_VALUE_FRAME_STORED_TO_BACKUP 2 //Yellow
#define PONDMAP_VALUE_FRAME_SENT_SUCESSFULLY 3 //Green
#define PONDMAP_VALUE_TAKEN_BUT_ERROR 4 // Red
#define POND_BOUNDARIES_NOT_AVAILABLE 5 // Black
...
public:
    ...
    void updatePondStatus(const char* pondName, int status);
};
